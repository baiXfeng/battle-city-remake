...
SurvivalView::SurvivalView(): _filter(new entity::ContactFilter(_c)), _listener(new entity::ContactListener(_c)) {
    ...
    entity::tank::create(_c, entity::Party::PLAYER, size() * 0.5f);
    entity::tank::create(_c, entity::Party::ENEMY, {size().x * 0.25f, size().y * 0.25f});
    entity::tank::create(_c, entity::Party::ENEMY, {size().x * 0.75f, size().y * 0.25f});
    entity::tank::create(_c, entity::Party::ENEMY, {size().x * 0.25f, size().y * 0.75f});
    entity::tank::create(_c, entity::Party::ENEMY, {size().x * 0.75f, size().y * 0.75f});

    _worker.push_back(entity::Worker::Ptr(new entity::PlayerInputWorker(_c)));

    auto ai_system = entity::System::Ptr(new entity::ObjectAI_System);
    ...
    _sys = entity::System::Ptr(new entity::SequenceSystem({
        ai_system,
        fire_system,
        move_system,
        physics_system,
